  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-b from-white via-secondary to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-20 right-10 w-40 h-40 border-4 border-accent rounded-lg transform -rotate-6"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-12">
          {sampleStrips.map((strip) => (
            ...
            >
              ...
              <div className="relative bg-white rounded-lg shadow-photo border-4 border-neutral-100 p-3 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:rotate-1">
              ...
              {hoveredId === strip.id && (
                <div className="absolute -bottom-2 left-0 right-0 z-20 bg-white rounded-lg shadow-lg border border-neutral-200 p-3 text-center transition-all">
        ...
        {/* CTA */}
        <div className="text-center bg-white rounded-xl shadow-md p-8 max-w-2xl mx-auto border-2 border-neutral-100">
          ...
          <button className="inline-flex items-center gap-2 bg-primary hover:bg-primary-dark text-white font-medium px-6 py-3 rounded-lg transition">
