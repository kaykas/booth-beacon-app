            ...
            <TabsContent value="crawler" className="mt-6">
              <Card className="p-6 bg-neutral-800 border-neutral-700">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-neutral-700 rounded-lg p-4 bg-neutral-900">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        ...
                        <p className="text-sm text-neutral-400">Monitor and control the booth data crawler</p>
                      </div>
                  ...
                  {/* Recent Activity */}
                  <div className="border border-neutral-700 rounded-lg p-4 bg-neutral-900">
                    <h3 className="font-semibold text-white mb-3">Recent Crawler Activity</h3>
                    <div className="text-center py-8">
                      <Clock className="w-12 h-12 text-neutral-600 mx-auto mb-3" />
                      <p className="text-neutral-400 text-sm">No crawler activity yet</p>
                      <p className="text-neutral-500 text-xs mt-1">Crawler functionality coming soon</p>
                    </div>
                  </div>
